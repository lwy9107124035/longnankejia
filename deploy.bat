...
"%PY%" -c "import zipfile,pathlib;src=pathlib.Path(r'%~dp0.');files=['index.html','css/style.css','js/config.js','js/store.js','js/knowledge-base.js','js/answer-engine.js','js/ui.js','js/admin.js','js/app.js','js/secrets.js'];exist=[f for f in files if (src/f).exists()];paths=[r'%ZIP_ARC%',r'%ZIP_DESK%'];\
